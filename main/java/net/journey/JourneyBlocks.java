	 ...
	 wastelandsBranches = new BlockModLeaves("wastelandsBranches", 2.0F).setStepSound(EnumMaterialTypes.WOOD.getSound()); */
		...
		public static void registerItemBlocks(IForgeRegistry<Item> registry) {
			...
			registry.registerAll(
					...
					luniumOre.createItemBlock(),
					hellstoneOre.createItemBlock(),
					ashualOre.createItemBlock(),
					blaziumOre.createItemBlock(),
					celestiumOre.createItemBlock(),
					mekyumOre.createItemBlock(),
					koriteOre.createItemBlock(),
					storonOre.createItemBlock(),
					flairiumOre.createItemBlock(),
					desOre.createItemBlock(),
					enderilliumOre.createItemBlock(),
					gorbiteOre.createItemBlock(),
					orbaditeOre.createItemBlock(),
					luniteOre.createItemBlock(),
					firestoneOre.createItemBlock(),
					sapphireBlock.createItemBlock(),
					shadiumBlock.createItemBlock(),
					luniumBlock.createItemBlock(),
					hellstoneBlock.createItemBlock(),
					ashualBlock.createItemBlock(),
					blaziumBlock.createItemBlock(),
					celestiumBlock.createItemBlock(),
					mekyumBlock.createItemBlock(),
					koriteBlock.createItemBlock(),
					storonBlock.createItemBlock(),
					flairiumBlock.createItemBlock(),
					desBlock.createItemBlock(),
					enderilliumBlock.createItemBlock(),
					gorbiteBlock.createItemBlock(),
					orbaditeBlock.createItemBlock(),
					luniteBlock.createItemBlock(),
					witherwoodLog.createItemBlock(),
					witherwoodLeaves.createItemBlock(),
					sizzlerWoodLeaves.createItemBlock(),
					sizzlerWoodLog.createItemBlock(),
					deathGrass.createItemBlock(),
					hellBell.createItemBlock(),
					hellshroom.createItemBlock(),
					heatSoil.createItemBlock(),
					igniterOn.createItemBlock(),
					igniter.createItemBlock(),
					greenGemBlock.createItemBlock(),
					...
					eucaGoldLog.createItemBlock(),
					goldEucaPlank.createItemBlock(),
					eucaGoldStairs.createItemBlock(),
					eucaGoldLeaves.createItemBlock(),
					eucaSilverLeaves.createItemBlock(),
					eucaSapling.createItemBlock(),
					eucaBricks.createItemBlock(),
					eucaTile.createItemBlock(),
					depthsDirt.createItemBlock(),
					depthsGrass.createItemBlock(),
					depthsStone.createItemBlock(),
					depthsLog.createItemBlock(),
					...
					iceLeaves.createItemBlock(),
					frozenDirt.createItemBlock(),
					frozenStone.createItemBlock(),
					frozenGrass.createItemBlock(),
					frozenLeaves.createItemBlock(),
					frozenBark.createItemBlock(),
					frozenPlanks.createItemBlock(),
					withanDirt.createItemBlock(),
					withanRock.createItemBlock(),
					withanGrass.createItemBlock(),
					withanLeaves.createItemBlock(),
					withanBark.createItemBlock(),
					withanRockReinforced.createItemBlock(),
					withanLamp.createItemBlock(),
					withanLight.createItemBlock(), 
					goldenGrass.createItemBlock(),
					goldenStone.createItemBlock(),
					corbaStone.createItemBlock(),
					corbaGrass.createItemBlock(),
					corbaLog.createItemBlock(),
					corbaLeaves.createItemBlock(),
					corbaPillar.createItemBlock(),
					corbaPlank.createItemBlock(),
					corbaLamp.createItemBlock(),
					corbaSentryBrick.createItemBlock(),
					boilingLamp.createItemBlock(),
					blazierBricks.createItemBlock(), 
					ashBlock.createItemBlock(),
					hotBlock.createItemBlock(),
					brisonStone.createItemBlock(),
					darkBrisonBrick.createItemBlock(),
					redBrisonBrick.createItemBlock(),
					smallBrisonBrick.createItemBlock(),
					boilingBars.createItemBlock(),
					burningLeaves.createItemBlock(),
					boilingLog.createItemBlock(), 
					cloudiaDirt.createItemBlock(),
					cloudiaGrass.createItemBlock(),
					cloudiaLog.createItemBlock(), 
					cloudiaRock.createItemBlock(), 
					cloudiaBrick.createItemBlock(), 
					cloudiaWall.createItemBlock(),  
					cloudiaTile.createItemBlock(),
					cloudiaLeaves.createItemBlock(),
					cloudiaLamp.createItemBlock(),
					pinkCloudiaCloud.createItemBlock(),
					blueCloudiaCloud.createItemBlock(),
					lightBlueCloudiaCloud.createItemBlock(),
					cloudiaTallGrass.createItemBlock(),
					cloudiaFlower.createItemBlock(),
					swampLamp.createItemBlock(),
					frozenChest.createItemBlock(),
					netherChest.createItemBlock(),
					boilingChest.createItemBlock(),
					eucaChest.createItemBlock(),
					depthsChest.createItemBlock(),
					...
					boilLock.createItemBlock(),
					darklyGate.createItemBlock(),
					darklyLock.createItemBlock(),
					corbaPost.createItemBlock(),
					sizzlingPost.createItemBlock(),
					senterianBricks.createItemBlock(),
					senterianRock.createItemBlock(),
					senterianCarvedRock.createItemBlock(),
					senterianFloor.createItemBlock(),
					senterianBars.createItemBlock(),
					senterianLightLamp.createItemBlock(),
					senterianMellowLamp.createItemBlock(),
					senterianGuardianLamp.createItemBlock(),
					senterianPost.createItemBlock(),
					trophy.createItemBlock(),
					trophySoul.createItemBlock(),
					trophyBlaze.createItemBlock(),
					trophyEudor.createItemBlock(),
					trophyCor.createItemBlock(),
					trophyScale.createItemBlock(),
					trophyRoc.createItemBlock(),
					trophySentry.createItemBlock(),
					trophyLogger.createItemBlock(),
					trophyTerra.createItemBlock(),
					trophyStalk.createItemBlock(),
					trophyNetherBeast.createItemBlock(),
					trophyWitherBeast.createItemBlock(),
					witherPortal.createItemBlock(),
					witherPortalFrame.createItemBlock(),
					eucaPortal.createItemBlock(),
					eucaPortalFrame.createItemBlock(),
					goldenPortal.createItemBlock(),
					goldenPortalFrame.createItemBlock(),
					depthsPortal.createItemBlock(),
					depthsPortalFrame.createItemBlock(),
					boilPortal.createItemBlock(),
					boilPortalFrame.createItemBlock(),
					frozenPortal.createItemBlock(),
					frozenPortalFrame.createItemBlock(),
					corbaPortal.createItemBlock(),
					corbaPortalFrame.createItemBlock(),
					terraniaPortal.createItemBlock(),
					terraniaPortalFrame.createItemBlock(),
					senterianPortal.createItemBlock(),
					senterianPortalFrame.createItemBlock(),
					cloudiaPortal.createItemBlock(),
					cloudiaPortalFrame.createItemBlock(),
					depthsLights.createItemBlock(),
					fire.createItemBlock(),
					mossyEssenceStone.createItemBlock(),
					...
					dungeonBrickStairs.createItemBlock(),
					...
					terranianLog.createItemBlock(),
					terranianGrass.createItemBlock(),
					terranianStone.createItemBlock(),
					terranianBars.createItemBlock(),
					terranianDarkPanels.createItemBlock(),
					terranianPanels.createItemBlock(),
					terranianTallgrass.createItemBlock(),
					terragrow.createItemBlock(),
					terraniaLamp.createItemBlock(),
					hotBrick.createItemBlock(),
					hotBrick_fence.createItemBlock(),
					hotBrick_stairs.createItemBlock(),
					hotGlass.createItemBlock(),
					smoothGlass.createItemBlock(),
					darkbloomTop.createItemBlock(),
					darkbloomBottom.createItemBlock(),
					redGlowshroomTop.createItemBlock(),
					redGlowshroomBottom.createItemBlock(),
					hellThornTop.createItemBlock(),
					hellThornBottom.createItemBlock(),
					hellThornRoot.createItemBlock(),
					nethicGrass.createItemBlock(),
					greenGlowshroomTop.createItemBlock(),
					greenGlowshroomBottom.createItemBlock(),
					blueGlowshroomTop.createItemBlock(),
					blueGlowshroomBottom.createItemBlock(),
					goldenStalksTop.createItemBlock(),
					goldenStalksBottom.createItemBlock(),
					goldenBulb.createItemBlock(),
					goldenBloom.createItemBlock(),
					goldenStalks.createItemBlock(),
					workshopCarpet.createItemBlock(),
					frozenGlass.createItemBlock(),
					frozenLamp.createItemBlock(),
					workshopStone.createItemBlock(),
					workshopStoneStair.createItemBlock(),
					workshopStoneFence.createItemBlock(),
					frozenDoor.createItemBlock(),
					candyCane.createItemBlock(),
					frozenBrick.createItemBlock(),
					icicle.createItemBlock(),
					frostberryThorn.createItemBlock(),
					iceBud.createItemBlock(),
					frozenBlooms.createItemBlock(),
					permaFlower.createItemBlock(),
					shiverFlower.createItemBlock(),
					iceBush.createItemBlock(),
					iceLog.createItemBlock(),
					brittleIce.createItemBlock(),
					eucaTallGrass.createItemBlock(),
					eucaTallFlowers.createItemBlock(),
					eucaBlueFlower.createItemBlock(),
					frozenFlower.createItemBlock(),
					depthsFlower.createItemBlock(),
					depthsBlueFlower.createItemBlock(),
					corbaFlower.createItemBlock(),
					corbaTallGrass.createItemBlock(),
					corbaSpeckledFlower.createItemBlock(),
					corbaLightPurpleFlower.createItemBlock(),
					corbaRedFlower.createItemBlock(),
					corbaBlueFlower.createItemBlock(),
					corbaDarkPurpleFlower.createItemBlock(),
					flameFlower.createItemBlock(),
					infernoPlant.createItemBlock(),
					burntGrass.createItemBlock(),
					grindstone.createItemBlock(),
					blueGems.createItemBlock(),
					redGems.createItemBlock(),
					blackBlock.createItemBlock(),
					whiteBlock.createItemBlock(),
					eucaPumpkin.createItemBlock(),
					cloud.createItemBlock(),
					corbaLadder.createItemBlock(),
					...
					silverbotSpawner.createItemBlock(),
					hellbotSpawner.createItemBlock(),
					purplianSpawner.createItemBlock(),
					starlightGolemSpawner.createItemBlock(),
					starlightTransporterSpawner.createItemBlock(),
					sentarAlter.createItemBlock(),
					sorcererSpawner.createItemBlock(),
					frostbiterSpawner.createItemBlock(),
					overseerSpawner.createItemBlock(),
		...
		public static void registerBlockModels() {
			...
			verditeOre.registerItemModel(SlayerAPI.toItem(verditeOre));
			sapphireOre.registerItemModel(SlayerAPI.toItem(sapphireOre));
			lavaRock.registerItemModel(SlayerAPI.toItem(lavaRock));
			shadiumOre.registerItemModel(SlayerAPI.toItem(shadiumOre));
			luniumOre.registerItemModel(SlayerAPI.toItem(luniumOre));
			hellstoneOre.registerItemModel(SlayerAPI.toItem(hellstoneOre));
			ashualOre.registerItemModel(SlayerAPI.toItem(ashualOre));
			blaziumOre.registerItemModel(SlayerAPI.toItem(blaziumOre));
			celestiumOre.registerItemModel(SlayerAPI.toItem(celestiumOre));
			mekyumOre.registerItemModel(SlayerAPI.toItem(mekyumOre));
			koriteOre.registerItemModel(SlayerAPI.toItem(koriteOre));
			storonOre.registerItemModel(SlayerAPI.toItem(storonOre));
			flairiumOre.registerItemModel(SlayerAPI.toItem(flairiumOre));
			desOre.registerItemModel(SlayerAPI.toItem(desOre));
			enderilliumOre.registerItemModel(SlayerAPI.toItem(enderilliumOre));
			gorbiteOre.registerItemModel(SlayerAPI.toItem(gorbiteOre));
			orbaditeOre.registerItemModel(SlayerAPI.toItem(orbaditeOre));
			luniteOre.registerItemModel(SlayerAPI.toItem(luniteOre));
			firestoneOre.registerItemModel(SlayerAPI.toItem(firestoneOre));
			sapphireBlock.registerItemModel(SlayerAPI.toItem(sapphireBlock));
			shadiumBlock.registerItemModel(SlayerAPI.toItem(shadiumBlock));
			luniumBlock.registerItemModel(SlayerAPI.toItem(luniumBlock));
			hellstoneBlock.registerItemModel(SlayerAPI.toItem(hellstoneBlock));
			ashualBlock.registerItemModel(SlayerAPI.toItem(ashualBlock));
			blaziumBlock.registerItemModel(SlayerAPI.toItem(blaziumBlock));
			celestiumBlock.registerItemModel(SlayerAPI.toItem(celestiumBlock));
			mekyumBlock.registerItemModel(SlayerAPI.toItem(mekyumBlock));
			koriteBlock.registerItemModel(SlayerAPI.toItem(koriteBlock));
			storonBlock.registerItemModel(SlayerAPI.toItem(storonBlock));
			flairiumBlock.registerItemModel(SlayerAPI.toItem(flairiumBlock));
			desBlock.registerItemModel(SlayerAPI.toItem(desBlock));
			enderilliumBlock.registerItemModel(SlayerAPI.toItem(enderilliumBlock));
			gorbiteBlock.registerItemModel(SlayerAPI.toItem(gorbiteBlock));
			orbaditeBlock.registerItemModel(SlayerAPI.toItem(orbaditeBlock));
			luniteBlock.registerItemModel(SlayerAPI.toItem(luniteBlock));
			witherwoodLog.registerItemModel(SlayerAPI.toItem(witherwoodLog));
			witherwoodLeaves.registerItemModel(SlayerAPI.toItem(witherwoodLeaves));
			sizzlerWoodLeaves.registerItemModel(SlayerAPI.toItem(sizzlerWoodLeaves));
			sizzlerWoodLog.registerItemModel(SlayerAPI.toItem(sizzlerWoodLog));
			deathGrass.registerItemModel(SlayerAPI.toItem(deathGrass));
			hellBell.registerItemModel(SlayerAPI.toItem(hellBell));
			hellshroom.registerItemModel(SlayerAPI.toItem(hellshroom));
			heatSoil.registerItemModel(SlayerAPI.toItem(heatSoil));
			igniterOn.registerItemModel(SlayerAPI.toItem(igniterOn));
			igniter.registerItemModel(SlayerAPI.toItem(igniter));
			greenGemBlock.registerItemModel(SlayerAPI.toItem(greenGemBlock));
			...
			eucaGoldLog.registerItemModel(SlayerAPI.toItem(eucaGoldLog));
			goldEucaPlank.registerItemModel(SlayerAPI.toItem(goldEucaPlank));
			eucaGoldStairs.registerItemModel(SlayerAPI.toItem(eucaGoldStairs));
			eucaGoldLeaves.registerItemModel(SlayerAPI.toItem(eucaGoldLeaves));
			eucaSilverLeaves.registerItemModel(SlayerAPI.toItem(eucaSilverLeaves));
			eucaSapling.registerItemModel(SlayerAPI.toItem(eucaSapling));
			eucaBricks.registerItemModel(SlayerAPI.toItem(eucaBricks));
			eucaTile.registerItemModel(SlayerAPI.toItem(eucaTile));
			depthsDirt.registerItemModel(SlayerAPI.toItem(depthsDirt));
			depthsGrass.registerItemModel(SlayerAPI.toItem(depthsGrass));
			depthsStone.registerItemModel(SlayerAPI.toItem(depthsStone));
			depthsLog.registerItemModel(SlayerAPI.toItem(depthsLog));
			depthsPlank.registerItemModel(SlayerAPI.toItem(depthsPlank));
			depthsStairs.registerItemModel(SlayerAPI.toItem(depthsStairs));
			depthsLeaves.registerItemModel(SlayerAPI.toItem(depthsLeaves));
			darkBrick.registerItemModel(SlayerAPI.toItem(darkBrick));
			darkFloor.registerItemModel(SlayerAPI.toItem(darkFloor));
			darkShingle.registerItemModel(SlayerAPI.toItem(darkShingle));
			iceLeaves.registerItemModel(SlayerAPI.toItem(iceLeaves));
			frozenDirt.registerItemModel(SlayerAPI.toItem(frozenDirt));
			frozenStone.registerItemModel(SlayerAPI.toItem(frozenStone));
			frozenGrass.registerItemModel(SlayerAPI.toItem(frozenGrass));
			frozenLeaves.registerItemModel(SlayerAPI.toItem(frozenLeaves));
			frozenBark.registerItemModel(SlayerAPI.toItem(frozenBark));
			frozenPlanks.registerItemModel(SlayerAPI.toItem(frozenPlanks));
			withanDirt.registerItemModel(SlayerAPI.toItem(withanDirt));
			withanRock.registerItemModel(SlayerAPI.toItem(withanRock));
			withanGrass.registerItemModel(SlayerAPI.toItem(withanGrass));
			withanLeaves.registerItemModel(SlayerAPI.toItem(withanLeaves));
			withanBark.registerItemModel(SlayerAPI.toItem(withanBark));
			withanRockReinforced.registerItemModel(SlayerAPI.toItem(withanRockReinforced));
			withanLamp.registerItemModel(SlayerAPI.toItem(withanLamp));
			withanLight.registerItemModel(SlayerAPI.toItem(withanLight)); 
			goldenGrass.registerItemModel(SlayerAPI.toItem(goldenGrass));
			goldenStone.registerItemModel(SlayerAPI.toItem(goldenStone));
			corbaStone.registerItemModel(SlayerAPI.toItem(corbaStone));
			corbaGrass.registerItemModel(SlayerAPI.toItem(corbaGrass));
			corbaLog.registerItemModel(SlayerAPI.toItem(corbaLog));
			corbaLeaves.registerItemModel(SlayerAPI.toItem(corbaLeaves));
			corbaPillar.registerItemModel(SlayerAPI.toItem(corbaPillar));
			corbaPlank.registerItemModel(SlayerAPI.toItem(corbaPlank));
			corbaLamp.registerItemModel(SlayerAPI.toItem(corbaLamp));
			corbaSentryBrick.registerItemModel(SlayerAPI.toItem(corbaSentryBrick));
			boilingLamp.registerItemModel(SlayerAPI.toItem(boilingLamp));
			blazierBricks.registerItemModel(SlayerAPI.toItem(blazierBricks)); 
			ashBlock.registerItemModel(SlayerAPI.toItem(ashBlock));
			hotBlock.registerItemModel(SlayerAPI.toItem(hotBlock));
			brisonStone.registerItemModel(SlayerAPI.toItem(brisonStone));
			darkBrisonBrick.registerItemModel(SlayerAPI.toItem(darkBrisonBrick));
			redBrisonBrick.registerItemModel(SlayerAPI.toItem(redBrisonBrick));
			smallBrisonBrick.registerItemModel(SlayerAPI.toItem(smallBrisonBrick));
			boilingBars.registerItemModel(SlayerAPI.toItem(boilingBars));
			burningLeaves.registerItemModel(SlayerAPI.toItem(burningLeaves));
			boilingLog.registerItemModel(SlayerAPI.toItem(boilingLog)); 
			cloudiaDirt.registerItemModel(SlayerAPI.toItem(cloudiaDirt));
			cloudiaGrass.registerItemModel(SlayerAPI.toItem(cloudiaGrass));
			cloudiaLog.registerItemModel(SlayerAPI.toItem(cloudiaLog)); 
			cloudiaRock.registerItemModel(SlayerAPI.toItem(cloudiaRock)); 
			cloudiaBrick.registerItemModel(SlayerAPI.toItem(cloudiaBrick)); 
			cloudiaWall.registerItemModel(SlayerAPI.toItem(cloudiaWall));  
			cloudiaTile.registerItemModel(SlayerAPI.toItem(cloudiaTile));
			cloudiaLeaves.registerItemModel(SlayerAPI.toItem(cloudiaLeaves));
			cloudiaLamp.registerItemModel(SlayerAPI.toItem(cloudiaLamp));
			pinkCloudiaCloud.registerItemModel(SlayerAPI.toItem(pinkCloudiaCloud));
			blueCloudiaCloud.registerItemModel(SlayerAPI.toItem(blueCloudiaCloud));
			lightBlueCloudiaCloud.registerItemModel(SlayerAPI.toItem(lightBlueCloudiaCloud));
			cloudiaTallGrass.registerItemModel(SlayerAPI.toItem(cloudiaTallGrass));
			cloudiaFlower.registerItemModel(SlayerAPI.toItem(cloudiaFlower));
			swampLamp.registerItemModel(SlayerAPI.toItem(swampLamp));
			frozenChest.registerItemModel(SlayerAPI.toItem(frozenChest));
			netherChest.registerItemModel(SlayerAPI.toItem(netherChest));
			boilingChest.registerItemModel(SlayerAPI.toItem(boilingChest));
			eucaChest.registerItemModel(SlayerAPI.toItem(eucaChest));
			depthsChest.registerItemModel(SlayerAPI.toItem(depthsChest));
			corbaChest.registerItemModel(SlayerAPI.toItem(corbaChest));
			cloudiaChest.registerItemModel(SlayerAPI.toItem(cloudiaChest));
			terraniaChest.registerItemModel(SlayerAPI.toItem(terraniaChest));
			nethicDungeonBricks.registerItemModel(SlayerAPI.toItem(nethicDungeonBricks));
			boilChain.registerItemModel(SlayerAPI.toItem(boilChain));
			boilGate.registerItemModel(SlayerAPI.toItem(boilGate));
			boilLock.registerItemModel(SlayerAPI.toItem(boilLock));
			darklyGate.registerItemModel(SlayerAPI.toItem(darklyGate));
			darklyLock.registerItemModel(SlayerAPI.toItem(darklyLock));
			corbaPost.registerItemModel(SlayerAPI.toItem(corbaPost));
			sizzlingPost.registerItemModel(SlayerAPI.toItem(sizzlingPost));
			senterianBricks.registerItemModel(SlayerAPI.toItem(senterianBricks));
			senterianRock.registerItemModel(SlayerAPI.toItem(senterianRock));
			senterianCarvedRock.registerItemModel(SlayerAPI.toItem(senterianCarvedRock));
			senterianFloor.registerItemModel(SlayerAPI.toItem(senterianFloor));
			senterianBars.registerItemModel(SlayerAPI.toItem(senterianBars));
			senterianLightLamp.registerItemModel(SlayerAPI.toItem(senterianLightLamp));
			senterianMellowLamp.registerItemModel(SlayerAPI.toItem(senterianMellowLamp));
			senterianGuardianLamp.registerItemModel(SlayerAPI.toItem(senterianGuardianLamp));
			senterianPost.registerItemModel(SlayerAPI.toItem(senterianPost));
			trophy.registerItemModel(SlayerAPI.toItem(trophy));
			trophySoul.registerItemModel(SlayerAPI.toItem(trophySoul));
			trophyBlaze.registerItemModel(SlayerAPI.toItem(trophyBlaze));
			trophyEudor.registerItemModel(SlayerAPI.toItem(trophyEudor));
			trophyCor.registerItemModel(SlayerAPI.toItem(trophyCor));
			trophyScale.registerItemModel(SlayerAPI.toItem(trophyScale));
			trophyRoc.registerItemModel(SlayerAPI.toItem(trophyRoc));
			trophySentry.registerItemModel(SlayerAPI.toItem(trophySentry));
			trophyLogger.registerItemModel(SlayerAPI.toItem(trophyLogger));
			trophyTerra.registerItemModel(SlayerAPI.toItem(trophyTerra));
			trophyStalk.registerItemModel(SlayerAPI.toItem(trophyStalk));
			trophyNetherBeast.registerItemModel(SlayerAPI.toItem(trophyNetherBeast));
			trophyWitherBeast.registerItemModel(SlayerAPI.toItem(trophyWitherBeast));
			witherPortal.registerItemModel(SlayerAPI.toItem(witherPortal));
			witherPortalFrame.registerItemModel(SlayerAPI.toItem(witherPortalFrame));
			eucaPortal.registerItemModel(SlayerAPI.toItem(eucaPortal));
			eucaPortalFrame.registerItemModel(SlayerAPI.toItem(eucaPortalFrame));
			goldenPortal.registerItemModel(SlayerAPI.toItem(goldenPortal));
			goldenPortalFrame.registerItemModel(SlayerAPI.toItem(goldenPortalFrame));
			depthsPortal.registerItemModel(SlayerAPI.toItem(depthsPortal));
			depthsPortalFrame.registerItemModel(SlayerAPI.toItem(depthsPortalFrame));
			boilPortal.registerItemModel(SlayerAPI.toItem(boilPortal));
			boilPortalFrame.registerItemModel(SlayerAPI.toItem(boilPortalFrame));
			frozenPortal.registerItemModel(SlayerAPI.toItem(frozenPortal));
			frozenPortalFrame.registerItemModel(SlayerAPI.toItem(frozenPortalFrame));
			corbaPortal.registerItemModel(SlayerAPI.toItem(corbaPortal));
			corbaPortalFrame.registerItemModel(SlayerAPI.toItem(corbaPortalFrame));
			terraniaPortal.registerItemModel(SlayerAPI.toItem(terraniaPortal));
			terraniaPortalFrame.registerItemModel(SlayerAPI.toItem(terraniaPortalFrame));
			senterianPortal.registerItemModel(SlayerAPI.toItem(senterianPortalFrame));
			senterianPortalFrame.registerItemModel(SlayerAPI.toItem(senterianPortalFrame));
			cloudiaPortal.registerItemModel(SlayerAPI.toItem(cloudiaPortal));
			cloudiaPortalFrame.registerItemModel(SlayerAPI.toItem(cloudiaPortalFrame));
			...
			dungeonBrickStairs.registerItemModel(SlayerAPI.toItem(dungeonBrickStairs));
			dungeonCrackedBrickStairs.registerItemModel(SlayerAPI.toItem(dungeonCrackedBrickStairs));
			...
			terranianLog.registerItemModel(SlayerAPI.toItem(terranianLog));
			terranianGrass.registerItemModel(SlayerAPI.toItem(terranianGrass));
			terranianStone.registerItemModel(SlayerAPI.toItem(terranianStone));
			terranianBars.registerItemModel(SlayerAPI.toItem(terranianBars));
			terranianDarkPanels.registerItemModel(SlayerAPI.toItem(terranianDarkPanels));
			terranianPanels.registerItemModel(SlayerAPI.toItem(terranianPanels));
			terranianTallgrass.registerItemModel(SlayerAPI.toItem(terranianTallgrass));
			terragrow.registerItemModel(SlayerAPI.toItem(terragrow));
			terraniaLamp.registerItemModel(SlayerAPI.toItem(terraniaLamp));
			hotBrick.registerItemModel(SlayerAPI.toItem(hotBrick));
			hotBrick_fence.registerItemModel(SlayerAPI.toItem(hotBrick_fence));
			hotBrick_stairs.registerItemModel(SlayerAPI.toItem(hotBrick_stairs));
			hotGlass.registerItemModel(SlayerAPI.toItem(hotGlass));
			smoothGlass.registerItemModel(SlayerAPI.toItem(smoothGlass));
			darkbloomTop.registerItemModel(SlayerAPI.toItem(darkbloomTop));
			darkbloomBottom.registerItemModel(SlayerAPI.toItem(darkbloomBottom));
			redGlowshroomTop.registerItemModel(SlayerAPI.toItem(redGlowshroomTop));
			redGlowshroomBottom.registerItemModel(SlayerAPI.toItem(redGlowshroomBottom));
			hellThornTop.registerItemModel(SlayerAPI.toItem(hellThornTop));
			hellThornBottom.registerItemModel(SlayerAPI.toItem(hellThornBottom));
			hellThornRoot.registerItemModel(SlayerAPI.toItem(hellThornRoot));
			nethicGrass.registerItemModel(SlayerAPI.toItem(nethicGrass));
			greenGlowshroomTop.registerItemModel(SlayerAPI.toItem(greenGlowshroomTop));
			greenGlowshroomBottom.registerItemModel(SlayerAPI.toItem(greenGlowshroomBottom));
			blueGlowshroomTop.registerItemModel(SlayerAPI.toItem(blueGlowshroomTop));
			blueGlowshroomBottom.registerItemModel(SlayerAPI.toItem(blueGlowshroomBottom));
			goldenStalksTop.registerItemModel(SlayerAPI.toItem(goldenStalksTop));
			goldenStalksBottom.registerItemModel(SlayerAPI.toItem(goldenStalksBottom));
			goldenBulb.registerItemModel(SlayerAPI.toItem(goldenBulb));
			goldenBloom.registerItemModel(SlayerAPI.toItem(goldenBloom));
			goldenStalks.registerItemModel(SlayerAPI.toItem(goldenStalks));
			workshopCarpet.registerItemModel(SlayerAPI.toItem(workshopCarpet));
			frozenGlass.registerItemModel(SlayerAPI.toItem(frozenGlass));
			frozenLamp.registerItemModel(SlayerAPI.toItem(frozenLamp));
			workshopStone.registerItemModel(SlayerAPI.toItem(workshopStone));
			workshopStoneStair.registerItemModel(SlayerAPI.toItem(workshopStoneStair));
			workshopStoneFence.registerItemModel(SlayerAPI.toItem(workshopStoneFence));
			frozenDoor.registerItemModel(SlayerAPI.toItem(frozenDoor));
			candyCane.registerItemModel(SlayerAPI.toItem(candyCane));
			frozenBrick.registerItemModel(SlayerAPI.toItem(frozenBrick));
			icicle.registerItemModel(SlayerAPI.toItem(icicle));
			frostberryThorn.registerItemModel(SlayerAPI.toItem(frostberryThorn));
			iceBud.registerItemModel(SlayerAPI.toItem(iceBud));
			frozenBlooms.registerItemModel(SlayerAPI.toItem(frozenBlooms));
			permaFlower.registerItemModel(SlayerAPI.toItem(permaFlower));
			shiverFlower.registerItemModel(SlayerAPI.toItem(shiverFlower));
			iceBush.registerItemModel(SlayerAPI.toItem(iceBush));
			iceLog.registerItemModel(SlayerAPI.toItem(iceLog));
			brittleIce.registerItemModel(SlayerAPI.toItem(brittleIce));
			eucaTallGrass.registerItemModel(SlayerAPI.toItem(eucaTallGrass));
			eucaTallFlowers.registerItemModel(SlayerAPI.toItem(eucaTallFlowers));
			eucaBlueFlower.registerItemModel(SlayerAPI.toItem(eucaBlueFlower));
			frozenFlower.registerItemModel(SlayerAPI.toItem(frozenFlower));
			depthsFlower.registerItemModel(SlayerAPI.toItem(depthsFlower));
			depthsBlueFlower.registerItemModel(SlayerAPI.toItem(depthsBlueFlower));
			corbaFlower.registerItemModel(SlayerAPI.toItem(corbaFlower));
			corbaTallGrass.registerItemModel(SlayerAPI.toItem(corbaTallGrass));
			corbaSpeckledFlower.registerItemModel(SlayerAPI.toItem(corbaSpeckledFlower));
			corbaLightPurpleFlower.registerItemModel(SlayerAPI.toItem(corbaLightPurpleFlower));
			corbaRedFlower.registerItemModel(SlayerAPI.toItem(corbaRedFlower));
			corbaBlueFlower.registerItemModel(SlayerAPI.toItem(corbaBlueFlower));
			corbaDarkPurpleFlower.registerItemModel(SlayerAPI.toItem(corbaDarkPurpleFlower));
			flameFlower.registerItemModel(SlayerAPI.toItem(flameFlower));
			infernoPlant.registerItemModel(SlayerAPI.toItem(infernoPlant));
			burntGrass.registerItemModel(SlayerAPI.toItem(burntGrass));
			grindstone.registerItemModel(SlayerAPI.toItem(grindstone));
			blueGems.registerItemModel(SlayerAPI.toItem(blueGems));
			redGems.registerItemModel(SlayerAPI.toItem(redGems));
			blackBlock.registerItemModel(SlayerAPI.toItem(blackBlock));
			whiteBlock.registerItemModel(SlayerAPI.toItem(whiteBlock));
			eucaPumpkin.registerItemModel(SlayerAPI.toItem(eucaPumpkin));
			cloud.registerItemModel(SlayerAPI.toItem(cloud));
			corbaLadder.registerItemModel(SlayerAPI.toItem(corbaLadder));
			largeNetherBrick.registerItemModel(SlayerAPI.toItem(largeNetherBrick));
			compactNetherBrick.registerItemModel(SlayerAPI.toItem(compactNetherBrick));
			nethicLamp.registerItemModel(SlayerAPI.toItem(nethicLamp));
			knowledgeTable.registerItemModel(SlayerAPI.toItem(knowledgeTable));
			summoningTable.registerItemModel(SlayerAPI.toItem(summoningTable));
			trophyTable.registerItemModel(SlayerAPI.toItem(trophyTable));
			bossAltar.registerItemModel(SlayerAPI.toItem(bossAltar));
			observerSpawner.registerItemModel(SlayerAPI.toItem(observerSpawner));
			screamerSpawner.registerItemModel(SlayerAPI.toItem(screamerSpawner));
			goldbotSpawner.registerItemModel(SlayerAPI.toItem(goldbotSpawner));
			silverbotSpawner.registerItemModel(SlayerAPI.toItem(silverbotSpawner));
			hellbotSpawner.registerItemModel(SlayerAPI.toItem(hellbotSpawner));
			purplianSpawner.registerItemModel(SlayerAPI.toItem(purplianSpawner));
			starlightGolemSpawner.registerItemModel(SlayerAPI.toItem(starlightGolemSpawner));
			starlightTransporterSpawner.registerItemModel(SlayerAPI.toItem(starlightTransporterSpawner));
			sentarAlter.registerItemModel(SlayerAPI.toItem(sentarAlter));
			sorcererSpawner.registerItemModel(SlayerAPI.toItem(sorcererSpawner));
			frostbiterSpawner.registerItemModel(SlayerAPI.toItem(frostbiterSpawner));
			overseerSpawner.registerItemModel(SlayerAPI.toItem(overseerSpawner));
			overseerElderSpawner.registerItemModel(SlayerAPI.toItem(overseerElderSpawner));
