...
public class MobStats {
	...
	public static double hardestJourneyDamage = 30.0D;
	public static double veryHardJourneyDamage = 25.0D;
	public static double hardJourneyDamage = 20.0D;
	public static double highJourneyDamage = 15.0D;
	public static double mediumJourneyDamage = 10.0D;
	public static double lowJourneyDamage = 5.0D;
	
	public static double baseJourneyDamage = 7.5D;
	...
	public static double frozenHealth = 35D;
	public static double flyingHealth = 20D;
	public static double highNetherHealth = 60D;
	public static double baseNetherHealth = 40D;
	public static double boilHealth = 80;
	public static double eucaHealth = 100;
	public static double depthsHealth = 200;
	public static double corbaHealth = 300;
	public static double terraniaHealth = 400;
	public static double cloudiaHealth = 500;
