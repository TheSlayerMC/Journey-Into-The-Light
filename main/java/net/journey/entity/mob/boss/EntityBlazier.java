...
public class EntityBlazier extends EntityEssenceBoss implements IRangedAttackMob {
	...
	public void onDeath(DamageSource damage) {
		...
		this.world.setBlockState(new BlockPos((int)Math.floor(this.posX + 0), ((int)Math.floor(this.posY + 0)), ((int)Math.floor(this.posZ + 0))), JourneyBlocks.boilingChest.getStateFromMeta(5));
