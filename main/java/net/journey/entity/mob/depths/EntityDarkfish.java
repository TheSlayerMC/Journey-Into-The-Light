...
public class EntityDarkfish extends EntityModFlying {
	...
	private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityDarkfish.class, DataSerializers.BOOLEAN);
	...
	protected void dropFewItems(boolean b, int j) {
		if(rand.nextInt(5) == 0) dropItem(JourneyItems.scale, rand.nextInt(3));
		if(rand.nextInt(10) == 0) dropItem(JourneyItems.darkOrb, 1);
