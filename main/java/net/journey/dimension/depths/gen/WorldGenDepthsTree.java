...
public class WorldGenDepthsTree extends WorldGenAbstractTree {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 2, j + 0, k + 2), JourneyBlocks.logs.getDefaultState().withProperty(BlockModLog.VARIANT, EnumTypeLogs.EnumType.DEPTHS_LOG));
		world.setBlockState(new BlockPos(i + 2, j + 1, k + 2), JourneyBlocks.logs.getDefaultState().withProperty(BlockModLog.VARIANT, EnumTypeLogs.EnumType.DEPTHS_LOG));
		world.setBlockState(new BlockPos(i + 2, j + 2, k + 2), JourneyBlocks.logs.getDefaultState().withProperty(BlockModLog.VARIANT, EnumTypeLogs.EnumType.DEPTHS_LOG));
		...
		world.setBlockState(new BlockPos(i + 2, j + 3, k + 2), JourneyBlocks.logs.getDefaultState().withProperty(BlockModLog.VARIANT, EnumTypeLogs.EnumType.DEPTHS_LOG));
		...
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 2), JourneyBlocks.logs.getDefaultState().withProperty(BlockModLog.VARIANT, EnumTypeLogs.EnumType.DEPTHS_LOG));
