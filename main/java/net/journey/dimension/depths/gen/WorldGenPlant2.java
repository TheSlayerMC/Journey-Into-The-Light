...
public class WorldGenPlant2 extends WorldGenAbstractTree {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 4, k + 0), JourneyBlocks.darkbloomBottom.getDefaultState());
		this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 5, k + 0), JourneyBlocks.darkbloomBottom.getDefaultState());
		this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 6, k + 0), JourneyBlocks.darkbloomTop.getDefaultState());
