...
public class WorldGenJourney implements IWorldGenerator {
	...
	public static void generateJourneyDimensions(int gen, World w, int chunkX, int chunkZ) {
		...
		case 3:
			...
			break;
		case 4:
			y = r.nextInt(200) + 1; x = chunkX + r.nextInt(16); z = chunkZ + r.nextInt(16);
		...
		case 5:
			...
			break;
		case 6:
			(new WorldGenModFlower(JourneyBlocks.eucaTallGrass, JourneyBlocks.eucaGrass))
                    .generate(w, r, new BlockPos(chunkX, 0, chunkZ));
			break;
		case 7:
			y = r.nextInt(300); x = chunkX + r.nextInt(16); z = chunkZ + r.nextInt(16);
		...
		case 8:
			...
			break;
		case 9:
			y = r.nextInt(60); x = chunkX + r.nextInt(16); z = chunkZ + r.nextInt(16);
		...
		case 17:
			...
			break;
		case 18:
			y = r.nextInt(200); x = chunkX + r.nextInt(16); z = chunkZ + r.nextInt(16);
