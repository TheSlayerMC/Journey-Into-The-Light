...
public class WorldGenBoilTree3 extends WorldGenerator {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 3, j + 0, k + 3), log);
		world.setBlockState(new BlockPos(i + 3, j + 1, k + 3), log);
		world.setBlockState(new BlockPos(i + 3, j + 2, k + 3), log);
		world.setBlockState(new BlockPos(i + 3, j + 3, k + 3), log);
		world.setBlockState(new BlockPos(i + 3, j + 4, k + 3), log);
		...
		world.setBlockState(new BlockPos(i + 3, j + 5, k + 3), log);
