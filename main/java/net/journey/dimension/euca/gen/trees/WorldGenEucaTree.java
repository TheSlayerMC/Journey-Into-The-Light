...
public class WorldGenEucaTree extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i - 4, j, k + 3), leaves);
		world.setBlockState(new BlockPos(i - 4, j, k + 4), leaves);
		world.setBlockState(new BlockPos(i - 4, j + 1, k), leaves);
		...
		world.setBlockState(new BlockPos(i - 3, j, k + 3), leaves);
		world.setBlockState(new BlockPos(i - 3, j, k + 4), leaves);
		world.setBlockState(new BlockPos(i - 3, j + 1, k - 1), leaves);
		world.setBlockState(new BlockPos(i - 3, j + 1, k), leaves);
		world.setBlockState(new BlockPos(i - 3, j + 1, k + 1), leaves);
		...
		world.setBlockState(new BlockPos(i - 1, j, k + 3), leaves);
		world.setBlockState(new BlockPos(i - 1, j, k + 4), leaves);
		world.setBlockState(new BlockPos(i - 1, j + 1, k - 3), leaves);
		...
		world.setBlockState(new BlockPos(i, j + 1, k - 4), leaves);
		world.setBlockState(new BlockPos(i, j + 1, k - 3), leaves);
