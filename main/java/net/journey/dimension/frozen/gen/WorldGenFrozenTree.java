...
public class WorldGenFrozenTree extends WorldGenHugeTrees {
	...
	private static final IBlockState GRASS = JourneyBlocks.frozenGrass.getDefaultState();
	private final boolean useBaseHeight;

	public WorldGenFrozenTree(boolean notify, boolean p_i45457_2_) {
	...
	private void placePodzolAt(World worldIn, BlockPos pos) {
		for (int i = 2; i >= -3; --i) {
			...
			if (block.canSustainPlant(iblockstate, worldIn, blockpos, net.minecraft.util.EnumFacing.UP,
				...
				this.setBlockAndNotifyAdequately(worldIn, blockpos, GRASS);
				break;
			}
