...
public class WorldGenFrozenTree3 extends WorldGenAbstractTree {

	private Block log = JourneyBlocks.frozenBark;
	private Block leaves = JourneyBlocks.frozenLeaves;
	
    public WorldGenFrozenTree3()
    {
        super(false);
        Random r = new Random();
    }
