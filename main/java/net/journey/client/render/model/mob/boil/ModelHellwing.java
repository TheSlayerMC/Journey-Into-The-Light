...
public class ModelHellwing extends ModelBiped {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.rightwing.rotateAngleZ = MathHelper.cos(par3 * 1.3F) * (float)Math.PI * 0.25F;
        this.leftwing.rotateAngleZ = -this.rightwing.rotateAngleZ;
        this.rightwing1.rotateAngleZ = this.rightwing.rotateAngleZ * 0.7F;
        this.leftwing1.rotateAngleZ = -this.rightwing.rotateAngleZ * 0.7F;
