...
import net.journey.client.render.model.item.*;
...
import net.journey.client.render.model.mob.overworld.*;
import net.journey.client.render.model.mob.overworld.cold.*;
import net.journey.client.render.model.mob.overworld.desert.*;
import net.journey.client.render.model.mob.overworld.jungle.*;
import net.journey.client.render.model.mob.overworld.underground.*;
import net.journey.client.render.model.mob.overworld.underground.npc.*;
import net.journey.client.render.model.mob.senterian.*;
import net.journey.client.render.model.mob.terrania.mob.*;
import net.journey.client.render.model.mob.terrania.npc.*;
...
import net.journey.entity.mob.overworld.*;
import net.journey.entity.mob.overworld.cold.*;
import net.journey.entity.mob.overworld.jungle.*;
import net.journey.entity.mob.overworld.npc.*;
import net.journey.entity.mob.overworld.underground.*;
import net.journey.entity.mob.overworld.underground.npc.*;
...
public class EntityRendering {
	...
	/**Projectiles*/
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityJourneyChest.class, new JourneyChestRenderer());
