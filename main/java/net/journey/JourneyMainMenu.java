...
public class JourneyMainMenu extends GuiMainMenu {
	...
	private static final ResourceLocation MINECRAFT_TITLE_TEXTURES =
			new ResourceLocation(SlayerAPI.PREFIX+"textures/gui/title/minecraft.png");
	private static final ResourceLocation field_194400_H = new ResourceLocation(SlayerAPI.PREFIX+"textures/gui/title/edition.png");
