...
public class JourneyAchievements {
	...
	public static StatBase achievementSapphireSword;
	public static StatBase achievementKillNether;
	public static StatBase achievementEuca;
	public static StatBase achievementDepths;
	public static StatBase achievementCorba;
	public static StatBase achievementTerrania;
	public static StatBase achievementCloudia;
	public static StatBase achievementFl;
	public static StatBase achievementCave;
	public static StatBase achievementPet;
	public static StatBase achievementRoc;
	public static StatBase achievementThunderbird;
	public static StatBase achievementNetherBeast;
	public static StatBase achievementWitherBeast;
	public static StatBase achievementSoul;
	public static StatBase achievementBlazier;
	public static StatBase achievementCorallator;
	public static StatBase achievementEudor;
	public static StatBase achievementScale;
	public static StatBase achievementlogger;
	...
	//public static StatBase addAchievement(String n, String id, int x, int y, ItemStack icon, StatBase a) {
		//Advancement achievement = new Advancement(n, id, x, y, icon, a);
