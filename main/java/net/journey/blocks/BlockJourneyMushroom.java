...
public class BlockJourneyMushroom extends BlockMod {
	...
	public static final PropertyEnum<BlockJourneyMushroom.EnumType> VARIANT = PropertyEnum.<BlockJourneyMushroom.EnumType>create(
	...
	public int getMetaFromState(IBlockState state) {
		return ((BlockJourneyMushroom.EnumType) state.getValue(VARIANT)).getMetadata();
	}
	...
	public IBlockState withRotation(IBlockState state, Rotation rot) {
		...
		case CLOCKWISE_180:
			...
			switch ((BlockJourneyMushroom.EnumType) state.getValue(VARIANT)) {
			case STEM:
				break;
			case NORTH_WEST:
	...
	public IBlockState withMirror(IBlockState state, Mirror mirrorIn) {
		BlockJourneyMushroom.EnumType blockhugemushroom$enumtype = (BlockJourneyMushroom.EnumType) state
				.getValue(VARIANT);
