...
@OnlyIn(Dist.CLIENT)
public class MinersPearlParticle extends SpriteTexturedParticle {
    private static final Random RANDOM = new Random();
    private final IAnimatedSprite sprites;

    private MinersPearlParticle(ClientWorld clientWorld, double x, double y, double z, double double1_, double motionY, double double_, IAnimatedSprite spriteWithAge) {
