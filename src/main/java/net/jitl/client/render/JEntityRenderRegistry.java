...
public class JEntityRenderRegistry {
    ...
    public static void registerEntityRenders() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(JEntities.EUCA_PIERCER_TYPE, manager -> new Entity2DRenderer<>(manager, JITL.rl("textures/item/euca_piercer.png"), 0.5F, false)); //TODO: change rendering
