...
public class LoreScrollScreen extends Screen {
    ...
    public LoreScrollScreen(ScrollCategory scrollCategory) {
        super(new TranslatableComponent("jitl.screen.lore_scroll"));
    ...
    @Override
    public void render(PoseStack poseStack_, int mouseX, int mouseY, float partialTick_) {
        renderBackground(poseStack_);
