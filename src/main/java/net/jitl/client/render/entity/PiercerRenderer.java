...
public class PiercerRenderer extends EntityRenderer<PiercerEntity> {
    ...
    public PiercerRenderer(EntityRendererManager renderManagerIn, net.minecraft.client.renderer.ItemRenderer itemRendererIn) {
    ...
    @Override
    public void render(PiercerEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
