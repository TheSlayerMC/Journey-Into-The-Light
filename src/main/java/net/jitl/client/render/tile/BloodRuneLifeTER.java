...
import net.jitl.common.tile.BloodRuneLifeTile;
...
public class BloodRuneLifeTER implements BlockEntityRenderer<BloodRuneLifeTile> {

    private final ItemRenderer renderEntity;

    public BloodRuneLifeTER(BlockEntityRendererProvider.Context context) {
        this.renderEntity = Minecraft.getInstance().getItemRenderer();
    }

    @Override
    public void render(BloodRuneLifeTile e, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
