...
import net.jitl.common.tile.BloodRuneFleshTile;
...
public class BloodRuneFleshTER implements BlockEntityRenderer<BloodRuneFleshTile> {

    private final ItemRenderer renderEntity;

    public BloodRuneFleshTER(BlockEntityRendererProvider.Context context) {
        this.renderEntity = Minecraft.getInstance().getItemRenderer();
    }

    @Override
    public void render(BloodRuneFleshTile e, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
