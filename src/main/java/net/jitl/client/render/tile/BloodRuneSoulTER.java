...
public class BloodRuneSoulTER implements BlockEntityRenderer<BloodRuneSoulTile> {

    private final ItemRenderer renderEntity;

    public BloodRuneSoulTER(BlockEntityRendererProvider.Context context) {
        this.renderEntity = Minecraft.getInstance().getItemRenderer();
    }

    @Override
    public void render(BloodRuneSoulTile e, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
