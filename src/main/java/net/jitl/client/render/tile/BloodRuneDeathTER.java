...
import net.jitl.common.tile.BloodRuneDeathTile;
...
public class BloodRuneDeathTER implements BlockEntityRenderer<BloodRuneDeathTile> {

    private final ItemRenderer renderEntity;

    public BloodRuneDeathTER(BlockEntityRendererProvider.Context context) {
        this.renderEntity = Minecraft.getInstance().getItemRenderer();
    }

    @Override
    public void render(BloodRuneDeathTile e, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
