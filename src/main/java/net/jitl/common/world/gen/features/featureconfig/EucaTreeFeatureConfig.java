...
public class EucaTreeFeatureConfig implements IFeatureConfig {
    ...
    public EucaTreeFeatureConfig(RuleTest spawnBlock, SimpleBlockStateProvider leafBlockProvider, SimpleBlockStateProvider logBlockProvider, int leafSize, int minHeight, int maxHeight) {
