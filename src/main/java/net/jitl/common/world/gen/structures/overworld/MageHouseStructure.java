...
public class MageHouseStructure extends Structure<NoFeatureConfig> {
    ...
    public MageHouseStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return MageHouseStructure.Start::new;
    }
    ...
    public static StructurePiece createPiece(TemplateManager templateManager, ResourceLocation templateLocation, BlockPos pos, boolean applyGenerationNoise) {
        return new MageHouseStructure.Piece(templateManager, templateLocation, pos);
    }
