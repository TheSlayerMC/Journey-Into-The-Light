...
public class NBTStructure extends StructureFeature<NoneFeatureConfiguration> {

    public static ResourceLocation NBT;
    public static Promised<StructurePieceType> type;
    private static int structX, structZ;

    public NBTStructure(ResourceLocation nbt, Promised<StructurePieceType> type, int x, int z) {
