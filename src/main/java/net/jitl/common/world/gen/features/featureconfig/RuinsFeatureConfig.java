...
public class RuinsFeatureConfig implements IFeatureConfig {
	...
	public RuinsFeatureConfig(RuleTest spawnBlock, WeightedBlockStateProvider ruinedBlocksProvider, int maxSpreading, int maxHeight, WeightedList<ResourceLocation> lootWeightedList) {
