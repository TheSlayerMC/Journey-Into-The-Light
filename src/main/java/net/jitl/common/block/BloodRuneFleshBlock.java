...
public class BloodRuneFleshBlock extends JTileContainerBlock {

    public BloodRuneFleshBlock(Properties properties) {
        super(properties, BloodRuneFleshTile::new);
    }
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (worldIn.getBlockEntity(pos) instanceof BloodRuneFleshTile rune) {
            rune.getItem(0);
