...
public class BloodRuneDeathBlock extends JTileContainerBlock {

    public BloodRuneDeathBlock(Properties properties) {
        super(properties, BloodRuneDeathTile::new);
    }
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (worldIn.getBlockEntity(pos) instanceof BloodRuneDeathTile rune) {
            rune.getItem(0);
