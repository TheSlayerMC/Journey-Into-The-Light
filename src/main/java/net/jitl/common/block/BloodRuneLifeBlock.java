...
public class BloodRuneLifeBlock extends JTileContainerBlock {

    public BloodRuneLifeBlock(Properties properties) {
        super(properties, BloodRuneLifeTile::new);
    }
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (worldIn.getBlockEntity(pos) instanceof BloodRuneLifeTile rune) {
            rune.getItem(0);
