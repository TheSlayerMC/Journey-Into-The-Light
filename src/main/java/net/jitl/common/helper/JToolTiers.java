...
public enum JToolTiers implements Tier {
    ...
    CELESTIUM(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.CELESTIUM_GEMSTONE),
    KORITE(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.KORITE_GEMSTONE),
    MEKYUM(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.MEKYUM_GEMSTONE),
    STORON(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.STORON_GEMSTONE),

    CREATIVE(1490, 12F, 1000F, 1000F, 1000F, 2.7F, JItems.STORON_GEMSTONE);
