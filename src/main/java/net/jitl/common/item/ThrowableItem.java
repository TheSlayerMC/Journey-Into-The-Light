...
public class ThrowableItem extends Item {
    ...
    protected Function<World, ThrowableEntity> projectileFactory;

    public ThrowableItem(Properties properties, Function<World, ThrowableEntity> projectileFactory) {
        super(properties);
    ...
    public @NotNull ActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, @NotNull Hand handIn) {
        ...
        if (!worldIn.isClientSide) {
            ThrowableEntity throwableEntity = projectileFactory.apply(worldIn);
