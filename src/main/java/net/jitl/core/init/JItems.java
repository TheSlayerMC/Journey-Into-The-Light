...
public class JItems {
    ...
    public static final Item RAW_CELESTIUM = promise();
    public static final Item RAW_KORITE = promise();
    public static final Item RAW_MEKYUM = promise();
    public static final Item RAW_STORON = promise();
