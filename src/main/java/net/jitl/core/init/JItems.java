...
public class JItems {
    ...
    public static final Item RAW_SHADIUM = promise();
    public static final Item BLOODCRUST_INGOT = promise();
    public static final Item RAW_BLOODCRUST = promise();
    public static final Item ASH = promise();
    public static final Item ENDERILLIUM_SHARD = promise();
    public static final Item CELESTIUM_GEMSTONE = promise();
    public static final Item KORITE_GEMSTONE = promise();
    public static final Item MEKYUM_GEMSTONE = promise();
    public static final Item STORON_GEMSTONE = promise();
    public static final Item OBSIDIAN_ROD = promise();
    public static final Item LUNIUM_POWDER = promise();
    public static final Item BLOOD = promise();
    public static final Item POWDER_OF_ESSENCIA = promise();
    ...
    public static final Item SAPPHIRE_MULTITOOL = promise();
    public static final Item SAPPHIRE_PICKAXE = promise();
    public static final Item SAPPHIRE_AXE = promise();
    public static final Item SAPPHIRE_SHOVEL = promise();
    public static final Item SAPPHIRE_HOE = promise();
    public static final Item SAPPHIRE_HELMET = promise();
    public static final Item SAPPHIRE_CHESTPLATE = promise();
    public static final Item SAPPHIRE_LEGGINGS = promise();
    public static final Item SAPPHIRE_BOOTS = promise();

    public static final Item LUNIUM_SWORD = promise();
    public static final Item LUNIUM_MULTITOOL = promise();
    public static final Item LUNIUM_PICKAXE = promise();
    public static final Item LUNIUM_AXE = promise();
    public static final Item LUNIUM_SHOVEL = promise();
    public static final Item LUNIUM_HOE = promise();
    public static final Item LUNIUM_HELMET = promise();
    public static final Item LUNIUM_CHESTPLATE = promise();
    ...
    public static final Item SHADIUM_AXE = promise();
    public static final Item SHADIUM_SHOVEL = promise();
    public static final Item SHADIUM_HOE = promise();
    public static final Item SHADIUM_HELMET = promise();
    public static final Item SHADIUM_CHESTPLATE = promise();
    public static final Item SHADIUM_LEGGINGS = promise();
    public static final Item SHADIUM_BOOTS = promise();

    public static final Item CELESTIUM_SWORD = promise();
    public static final Item CELESTIUM_MULTITOOL = promise();
    public static final Item CELESTIUM_PICKAXE = promise();
    public static final Item CELESTIUM_AXE = promise();
    public static final Item CELESTIUM_SHOVEL = promise();
    public static final Item CELESTIUM_HOE = promise();
    public static final Item CELESTIUM_HELMET = promise();
    public static final Item CELESTIUM_CHESTPLATE = promise();
    public static final Item CELESTIUM_LEGGINGS = promise();
    public static final Item CELESTIUM_BOOTS = promise();
    
    public static final Item KORITE_SWORD = promise();
    public static final Item KORITE_MULTITOOL = promise();
    public static final Item KORITE_PICKAXE = promise();
    public static final Item KORITE_AXE = promise();
    public static final Item KORITE_SHOVEL = promise();
    public static final Item KORITE_HOE = promise();

    public static final Item MEKYUM_SWORD = promise();
    public static final Item MEKYUM_MULTITOOL = promise();
    public static final Item MEKYUM_PICKAXE = promise();
    public static final Item MEKYUM_AXE = promise();
    public static final Item MEKYUM_SHOVEL = promise();
    public static final Item MEKYUM_HOE = promise();

    public static final Item STORON_SWORD = promise();
    public static final Item STORON_MULTITOOL = promise();
    public static final Item STORON_PICKAXE = promise();
    ...
    public static final Item HEART_CONTAINER_ULTIMATE = promise();
