    ...
    private void overworld(Consumer<Advancement> advancementConsumer) {
        Advancement root = Advancement.Builder.advancement()
                .display(
                        ...
                        new TranslatableComponent("jitl.advancement.overworld.root.title"),
                        new TranslatableComponent("jitl.advancement.overworld.root.desc"),
    ...
    private void frozen(Consumer<Advancement> advancementConsumer) {
        Advancement root = Advancement.Builder.advancement()
                .display(
                        ...
                        new TranslatableComponent("jitl.advancement.frozen.root.title"),
                        new TranslatableComponent("jitl.advancement.frozen.root.desc"),
        ...
        Advancement ride_capybara = Advancement.Builder.advancement()
                ...
                .display(
                        ...
                        new TranslatableComponent("jitl.advancement.frozen.ride_capybara.title"),
                        new TranslatableComponent("jitl.advancement.frozen.ride_capybara.desc"),
                        null,
                        FrameType.TASK,
                        true,
                        true,
