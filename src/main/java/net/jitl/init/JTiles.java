...
import net.jitl.common.tile.GuardianTowerHeartTile;
...
public class JTiles {
    ...
    public static final TileEntityType<EssenciaAltarTile> GUARDIAN_TOWER_HEART = promise();
    ...
    private static class Registrator {
        ...
        private static void register() {
            ...
            REGISTER.registerSingleBound("guardian_tower_heart", GuardianTowerHeartTile::new, () -> JBlocks.GUARDIAN_TOWER_HEART);
        }
    }
}
