...
public class JFoods {
    ...
    public static final Food CRYSTAL_APPLE = (new Food.Builder()).nutrition(8).saturationMod(2.2F)
            ...
            .effect(() -> new EffectInstance(Effects.DAMAGE_RESISTANCE, 8000, 0), 1.0F)
            .effect(() -> new EffectInstance(Effects.FIRE_RESISTANCE, 8000, 0), 1.0F)
            .effect(() -> new EffectInstance(Effects.FIRE_RESISTANCE, 8000, 0), 1.0F)
            .effect(() -> new EffectInstance(Effects.MOVEMENT_SPEED, 8000, 1), 1.0F)
            .effect(() -> new EffectInstance(Effects.DAMAGE_BOOST, 8000, 2), 1.0F)
            .effect(() -> new EffectInstance(Effects.HEAL, 10, 1), 1.0F)
            .effect(() -> new EffectInstance(Effects.ABSORPTION, 3400, 4), 1.0F)
            .effect(() -> new EffectInstance(JEffects.FROSTBURN.get(), 3400, 4), 1.0F)
            .alwaysEat().build();
