...
import ru.timeconqueror.timecore.registry.newreg.VanillaRegister;

public class JStructurePieces {
    @AutoRegistrable
    private static final VanillaRegister<IStructurePieceType> REGISTER = new VanillaRegister<>(JITL.MODID, Registry.STRUCTURE_PIECE);
