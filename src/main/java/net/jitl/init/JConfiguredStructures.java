...
public class JConfiguredStructures {
    /**
     * Static instance of our structure so we can reference it and add it to biomes easily.
     */
    public static StructureFeature<?, ?> CONFIGURED_GUARDIAN_TOWER = JStructures.GUARDIAN_TOWER.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(JITL.MODID, "configured_guardian_tower"), CONFIGURED_GUARDIAN_TOWER);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(JStructures.GUARDIAN_TOWER.get(), CONFIGURED_GUARDIAN_TOWER);
    }
}