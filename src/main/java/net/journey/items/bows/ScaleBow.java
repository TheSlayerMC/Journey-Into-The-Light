...
public class ScaleBow extends ItemModBow {

    public ScaleBow(String unlocalizedName, int damage, int durability) {
        super(unlocalizedName, "Scale Bow", durability, damage, "Withers targets");
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return entityIn.getActiveItemStack().getItem() != JourneyWeapons.scaleBow ? 0.0F
