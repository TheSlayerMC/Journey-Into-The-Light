...
public class ItemSentryEye extends JItem {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (player.canPlayerEdit(pos.offset(facing), facing, itemstack) && iblockstate.getBlock() == JourneyBlocks.senterianPortalFrame && !iblockstate.getValue(BlockSenterianPortalFrame.EYE).booleanValue()) {
            if (worldIn.isRemote) {
