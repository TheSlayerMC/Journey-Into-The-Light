...
public class ItemStunWitherSword extends ItemModSword {
    ...
    public ItemStunWitherSword(String name, String f, JourneyToolMaterial toolMaterial) {
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase hit, EntityLivingBase player) {
        ...
        hit.addPotionEffect(new PotionEffect(PotionEffects.setPotionEffect(PotionEffects.wither, 100, 2)));
        addParticles(hit);
