...
public class WorldGenFrozenTree3 extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random r, BlockPos bp) {
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i, j + 3, k + 4), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 1, j + 3, k + 5), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 1, j + 6, k + 3), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 2, j + 6, k + 4), leaves);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 2, j + 7, k + 1), leaves);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 2, j + 7, k + 2), log);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 2, j + 7, k + 3), log);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 3, j + 6, k + 1), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 3, j + 6, k + 4), leaves);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 3, j + 7, k + 1), leaves);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 3, j + 7, k + 2), log);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 3, j + 7, k + 3), log);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 4, j + 3, k), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 4, j + 3, k + 5), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 4, j + 6, k + 2), leaves);
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 4, j + 6, k + 3), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 5, j + 3, k + 1), leaves);
        ...
        this.setBlockAndNotifyAdequately(worldIn, new BlockPos(i + 5, j + 3, k + 4), leaves);
        return true;
    }
}
