...
public class StructureCorbaVillagePieces {
	...
	public static void registerVillagePieces() {
		...
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.House1.class, "CorbaVillageHouse1");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.Field1.class, "CorbaVillageField1");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.Field2.class, "CorbaVillageField2");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.Torch.class, "CorbaVillageTorch");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.Hall.class, "CorbaVillageHall");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.House4Garden.class, "CorbaVillageGarden");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.WoodHut.class, "CorbaVillageWoodHut");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.Church.class, "CorbaVillageChurch");
		SlayerAPI.addMapGen(StructureCorbaVillagePieces.House2.class, "CorbaVillageHouse2");
	...
	public static List<StructureCorbaVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random,
		...
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.House4Garden.class, 4,
		...
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Hall.class, 15,
				MathHelper.getInt(random, 0 + size, 2 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Field1.class, 3,
				MathHelper.getInt(random, 1 + size, 4 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Field2.class, 3,
				MathHelper.getInt(random, 2 + size, 4 + size * 2)));
		...
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.House3.class, 8,
	...
	private static StructureCorbaVillagePieces.Village findAndCreateComponentFactory(
		...
		if (oclass == StructureCorbaVillagePieces.House4Garden.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.House4Garden.createPiece(start,
			...
			structurevillagepieces$village = StructureCorbaVillagePieces.Hall.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCorbaVillagePieces.Field1.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Field1.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCorbaVillagePieces.Field2.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Field2.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
			...
			structurevillagepieces$village = StructureCorbaVillagePieces.House3.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else {
	...
	public static class Church extends StructureCorbaVillagePieces.Village {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate = JourneyBlocks.corbaStone.getDefaultState();
			...
			IBlockState iblockstate4 = JourneyBlocks.corbaLadder.getDefaultState().withProperty(BlockLadder.FACING,
					EnumFacing.WEST);
	...
	public static class Field1 extends StructureCorbaVillagePieces.Village {
		...
		public Field1(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.Field1 createPiece(StructureCorbaVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null
							? new StructureCorbaVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate = this.getBiomeSpecificBlockState(JourneyBlocks.corbaLog.getDefaultState());
			...
			for (int j2 = 0; j2 < 9; ++j2) {
				for (int k2 = 0; k2 < 13; ++k2) {
					...
					this.replaceAirAndLiquidDownwards(worldIn, JourneyBlocks.corbaStone.getDefaultState(), k2, -1, j2,
							structureBoundingBoxIn);
				}
			}
	...
	public static class Field2 extends StructureCorbaVillagePieces.Village {
		/** First crop type for this field. */
		private Block cropTypeA;
		/** Second crop type for this field. */
		private Block cropTypeB;
		...
		public Field2(StructureCorbaVillagePieces.Start start, int p_i45569_2_, Random rand,
		...
		public static StructureCorbaVillagePieces.Field2 createPiece(StructureCorbaVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null
							? new StructureCorbaVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			for (int j1 = 0; j1 < 9; ++j1) {
				for (int k1 = 0; k1 < 7; ++k1) {
					...
					this.replaceAirAndLiquidDownwards(worldIn, JourneyBlocks.corbaStone.getDefaultState(), k1, -1, j1,
							structureBoundingBoxIn);
				}
			}
	...
	public static class Hall extends StructureCorbaVillagePieces.Village {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate4 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaPlank.getDefaultState());
			IBlockState iblockstate5 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaLog.getDefaultState());
			IBlockState iblockstate6 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaPost.getDefaultState());
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 0, 6, 8, 0, 10,
					JourneyBlocks.corbaStone.getDefaultState(), JourneyBlocks.corbaStone.getDefaultState(), false);
	...
	public static class House1 extends StructureCorbaVillagePieces.Village {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 0, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 1, k + 0, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 1, k + 1, Blocks.COBBLESTONE_WALL.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 1, k + 9, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 1, k + 10, Blocks.COBBLESTONE_WALL.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 1, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 0, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 1, k + 10, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 2, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 3, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 2, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 3, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 7, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 8, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 6, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 6, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 6, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 7, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 2, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 1, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 1, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 2, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 2, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 3, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 3, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 3, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 4, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 5, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 1, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 1, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 2, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 2, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 3, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 3, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 6, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 7, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 2, k + 8, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 3, k + 8, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 4, k + 8, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 8, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 1, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 1, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 2, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 2, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 3, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 3, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 9, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 10, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 1, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 1, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 2, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 2, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 3, k + 1, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 3, k + 9, Blocks.OAK_FENCE.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 11, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 1, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 1, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 1, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 2, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 2, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 3, k + 1, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 3, k + 9, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 12, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 0, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 5, Blocks.OAK_DOOR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 1, k + 10, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 0, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 2, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 2, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 8, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 3, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 2, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 3, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 7, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 8, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 3, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 7, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 6, k + 4, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 6, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 6, k + 6, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 7, k + 5, Blocks.OAK_FENCE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 13, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 0, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 1, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 2, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 3, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 4, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 5, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 6, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 7, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 8, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 9, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 0, k + 10, Blocks.COBBLESTONE.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 1, k + 0, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 1, k + 1, Blocks.COBBLESTONE_WALL.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 1, k + 9, Blocks.COBBLESTONE_WALL.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 1, k + 10, Blocks.COBBLESTONE_WALL.getDefaultState());
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 4, k + 1, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 4, k + 9, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 5, k + 2, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 5, k + 8, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 6, k + 3, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 6, k + 7, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 7, k + 4, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 7, k + 5, Blocks.AIR.getDefaultState());
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 7, k + 6, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 14, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 15, j + 8, k + 5, (IBlockState)Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
			...
			this.setBlockState(worldIn, structureBoundingBoxIn, i + 15, j + 9, k + 5, (IBlockState)Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
	...
	public static class House2 extends StructureCorbaVillagePieces.Village {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate2 = this.getBiomeSpecificBlockState(
					Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST));
			IBlockState iblockstate3 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaPlank.getDefaultState());
			...
			for (int i = 6; i <= 8; ++i) {
				if (this.getBlockStateFromPos(worldIn, i, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR
					...
					if (this.getBlockStateFromPos(worldIn, i, -1, -1, structureBoundingBoxIn)
							.getBlock() == JourneyBlocks.corbaGrassPath) {
						this.setBlockState(worldIn, JourneyBlocks.corbaGrass.getDefaultState(), i, -1, -1,
								structureBoundingBoxIn);
					}
				}
			}
	...
	public static class House4Garden extends StructureCorbaVillagePieces.Village {
		private boolean isRoofAccessible;

		public House4Garden() {
		}

		public House4Garden(StructureCorbaVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing) {
		...
		public static StructureCorbaVillagePieces.House4Garden createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> component, Random rand, int x, int y, int z, EnumFacing facing, int par1) {
			StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 5, 6, 5, facing);
			return StructureComponent.findIntersecting(component, structureboundingbox) != null ? null : new StructureCorbaVillagePieces.House4Garden(start, par1, rand, structureboundingbox,
							facing);
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate2 = this.getBiomeSpecificBlockState(
					Blocks.STONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.NORTH));
			IBlockState iblockstate3 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaLog.getDefaultState());
			IBlockState iblockstate4 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaPost.getDefaultState());
	...
	public static class Well extends StructureCorbaVillagePieces.Village {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			IBlockState iblockstate = this.getBiomeSpecificBlockState(JourneyBlocks.corbaStone.getDefaultState());
			IBlockState iblockstate1 = this.getBiomeSpecificBlockState(JourneyBlocks.corbaPost.getDefaultState());
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			if (this.getBlockStateFromPos(worldIn, 1, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR
				...
				if (this.getBlockStateFromPos(worldIn, 1, -1, -1, structureBoundingBoxIn)
						.getBlock() == JourneyBlocks.corbaGrassPath) {
					this.setBlockState(worldIn, JourneyBlocks.corbaGrass.getDefaultState(), 1, -1, -1,
							structureBoundingBoxIn);
				}
			}
