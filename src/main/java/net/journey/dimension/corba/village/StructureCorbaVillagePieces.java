...
public class StructureCorbaVillagePieces {
	...
	public static List<StructureCorbaVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size) {
		...
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
		list.add(new StructureCorbaVillagePieces.PieceWeight(StructureCorbaVillagePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
	...
	private static StructureCorbaVillagePieces.Village findAndCreateComponentFactory(StructureCorbaVillagePieces.Start start, StructureCorbaVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
		...
		if (oclass == StructureCorbaVillagePieces.House4Garden.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.Church.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.House1.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.WoodHut.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.Hall.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.Field1.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.Field2.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == StructureCorbaVillagePieces.House2.class) {
			structurevillagepieces$village = StructureCorbaVillagePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
	...
	private static StructureCorbaVillagePieces.Village generateComponent(StructureCorbaVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
	{
		...
		else
		{
			...
			StructureBoundingBox structureboundingbox = StructureCorbaVillagePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);
	...
	private static StructureComponent generateAndAddRoadPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
	{
		...
		{
			StructureBoundingBox structureboundingbox = StructureCorbaVillagePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

			if (structureboundingbox != null && structureboundingbox.minY > 10)
			{
				StructureComponent structurecomponent = new StructureCorbaVillagePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
	...
	public static class Church extends StructureCorbaVillagePieces.Village
	{
		...
		public Church(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
		{
			super(start, type);
		...
		public static StructureCorbaVillagePieces.Church createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			IBlockState iblockstate4 = JourneyBlocks.corbaLadder.getDefaultState().withProperty(BlockLadder.FACING, EnumFacing.WEST);
			...
			if (this.getBlockStateFromPos(worldIn, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(worldIn, 2, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				...
				{
					this.setBlockState(worldIn, JourneyBlocks.corbaGrass.getDefaultState(), 2, -1, -1, structureBoundingBoxIn);
				}
			}
	...
	public static class Field1 extends StructureCorbaVillagePieces.Village
	{
		...
		public Field1(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
		{
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.Field1 createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			for (int j2 = 0; j2 < 9; ++j2)
			{
				for (int k2 = 0; k2 < 13; ++k2)
				{
					...
					this.replaceAirAndLiquidDownwards(worldIn, JourneyBlocks.corbaStone.getDefaultState(), k2, -1, j2, structureBoundingBoxIn);
				}
			}
	...
	public static class Field2 extends StructureCorbaVillagePieces.Village
	{
		...
		public Field2(StructureCorbaVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
		{
		...
		public static StructureCorbaVillagePieces.Field2 createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			for (int j1 = 0; j1 < 9; ++j1)
			{
				for (int k1 = 0; k1 < 7; ++k1)
				{
					...
					this.replaceAirAndLiquidDownwards(worldIn, JourneyBlocks.corbaStone.getDefaultState(), k1, -1, j1, structureBoundingBoxIn);
				}
			}
	...
	public static class Hall extends StructureCorbaVillagePieces.Village
	{
		...
		public Hall(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
		{
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.Hall createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 0, 6, 8, 0, 10, JourneyBlocks.corbaStone.getDefaultState(), JourneyBlocks.corbaStone.getDefaultState(), false);
	...
	public static class House1 extends StructureCorbaVillagePieces.Village
	{
		...
		public House1(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
		{
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.House1 createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			if (this.getBlockStateFromPos(worldIn, 1, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(worldIn, 1, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				...
				{
					this.setBlockState(worldIn, JourneyBlocks.corbaGrass.getDefaultState(), 1, -1, -1, structureBoundingBoxIn);
				}
			}
	...
	public static class House2 extends StructureCorbaVillagePieces.Village
	{
		...
		public House2(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
		{
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.House2 createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
		{
			...
			for (int i = 6; i <= 8; ++i)
			{
				if (this.getBlockStateFromPos(worldIn, i, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(worldIn, i, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
				{
					...
					{
						this.setBlockState(worldIn, JourneyBlocks.corbaGrass.getDefaultState(), i, -1, -1, structureBoundingBoxIn);
					}
				}
			}
	...
	public static class House3 extends StructureCorbaVillagePieces.Village
	{
		...
		public House3(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
		{
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.House3 createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
		{
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
		}
	...
	public static class House4Garden extends StructureCorbaVillagePieces.Village
	{
		...
		public static StructureCorbaVillagePieces.House4Garden createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
		{
			...
			return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureCorbaVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
		}
	...
	public static class Path extends StructureCorbaVillagePieces.Road
	{
		...
		public Path(StructureCorbaVillagePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
		{
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
		{
			...
			{
				StructureComponent structurecomponent = this.getNextComponentNN((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, 0, i);
			...
			{
				StructureComponent structurecomponent1 = this.getNextComponentPP((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, 0, j);
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null)
			{
				...
				case NORTH:
				default:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
					break;
				case SOUTH:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
					break;
				case WEST:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
					break;
				case EAST:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
				}
			}
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null)
			{
				...
				case NORTH:
				default:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
					break;
				case SOUTH:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
					break;
				case WEST:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
					break;
				case EAST:
					StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
				}
			}
		}

		public static StructureBoundingBox findPieceBox(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
		{
				...
				for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j)
				{
					...
					if (structureBoundingBoxIn.isVecInside(blockpos))
					{
						...
						while (blockpos.getY() >= worldIn.getSeaLevel() - 1)
						{
							...
							if (iblockstate4.getBlock() == JourneyBlocks.corbaGrass && worldIn.isAirBlock(blockpos.up()))
							{
	...
	public static class PieceWeight
	{
		...
		public PieceWeight(Class <? extends StructureCorbaVillagePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
		{
	...
	public static class Start extends StructureCorbaVillagePieces.Well
	{
		...
		public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<StructureCorbaVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
		{
	...
	public static class Torch extends StructureCorbaVillagePieces.Village
	{
		...
		public Torch(StructureCorbaVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
		{
		...
		public static StructureBoundingBox findPieceBox(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
		{
	...
	public abstract static class Village extends StructureComponent
	{
		 ...
		 */
		@Nullable
		protected StructureComponent getNextComponentNN(StructureCorbaVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
		{
			EnumFacing enumfacing = this.getCoordBaseMode();
			...
			if (enumfacing != null)
			{
				...
				case NORTH:
				default:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
				case SOUTH:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
				case WEST:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
				case EAST:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
				}
			}
		 ...
		 */
		@Nullable
		protected StructureComponent getNextComponentPP(StructureCorbaVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
		{
			EnumFacing enumfacing = this.getCoordBaseMode();
			...
			if (enumfacing != null)
			{
				...
				case NORTH:
				default:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
				case SOUTH:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
				case WEST:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
				case EAST:
					return StructureCorbaVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
				}
			}
		...
		protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn)
		{
			...
			{
				if (blockstateIn.getBlock() == JourneyBlocks.corbaLog || blockstateIn.getBlock() == JourneyBlocks.corbaLog)
				{
			...
			else if (this.structureType == 3)
			{
				if (blockstateIn.getBlock() == JourneyBlocks.corbaLog || blockstateIn.getBlock() == JourneyBlocks.corbaLog)
				{
					return JourneyBlocks.corbaLog.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLog.LOG_AXIS, blockstateIn.getValue(BlockLog.LOG_AXIS));
				}

				if (blockstateIn.getBlock() == Blocks.PLANKS)
				{
					return JourneyBlocks.corbaPlank.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE);
				}
			...
			else if (this.structureType == 2)
			{
				if (blockstateIn.getBlock() == JourneyBlocks.corbaLog || blockstateIn.getBlock() == JourneyBlocks.corbaLog)
				{
					return JourneyBlocks.corbaLog.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, blockstateIn.getValue(BlockLog.LOG_AXIS));
				}

				if (blockstateIn.getBlock() == Blocks.PLANKS)
				{
					return JourneyBlocks.corbaPlank.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA);
				}
				...
				if (blockstateIn.getBlock() == JourneyBlocks.corbaStone)
				{
					return JourneyBlocks.corbaLog.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y);
				}
	...
	public static class Well extends StructureCorbaVillagePieces.Village
	{
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
		{
			StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
			StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
			StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			StructureCorbaVillagePieces.generateAndAddRoadPiece((StructureCorbaVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
		}
	...
	public static class WoodHut extends StructureCorbaVillagePieces.Village {
		...
		public WoodHut(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCorbaVillagePieces.WoodHut createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_) {
			...
			return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureCorbaVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 2, 0, 3, JourneyBlocks.corbaStone.getDefaultState(), JourneyBlocks.corbaStone.getDefaultState(), false);
