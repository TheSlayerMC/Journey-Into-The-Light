...
public class StructureCorbaVillagePieces {
	...
	public static class House4Garden extends StructureCorbaVillagePieces.Village {
		...
		public House4Garden(StructureCorbaVillagePieces.Start start, int p_i45566_2_, Random rand,
		...
		public static StructureCorbaVillagePieces.House4Garden createPiece(StructureCorbaVillagePieces.Start start,
			...
			return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null
					: new StructureCorbaVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox,
							facing);
		}
