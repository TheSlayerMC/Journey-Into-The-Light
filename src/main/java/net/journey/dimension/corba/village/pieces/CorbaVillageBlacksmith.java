...
public class CorbaVillageBlacksmith extends StructureCorbaVillagePieces.Village {
	...
	public CorbaVillageBlacksmith(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox boundingBox, EnumFacing facing) {
		super(start, type);
		this.setCoordBaseMode(facing);
		this.boundingBox = boundingBox;
	}

	public static CorbaVillageBlacksmith createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> component, Random rand, int x, int y, int z, EnumFacing facing, int var1) {
		StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 11, 9, 11, facing);
		return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(component, structureboundingbox) == null ? new CorbaVillageBlacksmith(start, var1, rand, structureboundingbox, facing) : null;
	}
