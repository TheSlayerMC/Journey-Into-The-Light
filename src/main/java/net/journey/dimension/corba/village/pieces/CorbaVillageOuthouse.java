...
public class CorbaVillageOuthouse extends StructureCorbaVillagePieces.Village {
	private boolean isTallHouse;
	private int tablePosition;

	public CorbaVillageOuthouse() {}

	public CorbaVillageOuthouse(StructureCorbaVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
		super(start, type);
	...
	public static CorbaVillageOuthouse createPiece(StructureCorbaVillagePieces.Start start, List<StructureComponent> component, Random rand, int x, int y, int z, EnumFacing facing, int type) {
		StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 8, 6, 8, facing);
		return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(component, structureboundingbox) == null ? new CorbaVillageOuthouse(start, type, rand, structureboundingbox, facing) : null;
	}
