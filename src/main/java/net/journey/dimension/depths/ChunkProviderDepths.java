...
public class ChunkProviderDepths implements IChunkGenerator {
    ...
    private void generateNoise(int x, int y, int z) {
        this.gen4 = this.noiseGen6.generateNoiseOctaves(this.gen4, x, z, 5, 5, this.settings.depthNoiseScaleX, this.settings.depthNoiseScaleZ, this.settings.depthNoiseScaleExponent);
        float f = this.settings.coordinateScale;
        float f1 = this.settings.heightScale;
        this.gen1 = this.noiseGen3.generateNoiseOctaves(this.gen1, x, y, z, 5, 33, 5, f / this.settings.mainNoiseScaleX / 500, f1 / this.settings.mainNoiseScaleY, f / this.settings.mainNoiseScaleZ / 500);
