...
public class ChunkProviderEndJourney extends ChunkGeneratorEnd implements IChunkGenerator {
    ...
    public ChunkProviderEndJourney(World world, boolean p_i47241_2_, long p_i47241_3_, BlockPos pos) {
        super(world, p_i47241_2_, p_i47241_3_, pos);
        this.world = world;
        ...
        this.endCityGen = (MapGenEndCity) net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(
                this.endCityGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.END_CITY);
    }
    ...
    public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position,
        ...
        return "EndCity".equals(structureName) && this.endCityGen != null
                ? this.endCityGen.getNearestStructurePos(worldIn, position, findUnexplored) : null;
    }
