...
public class WorldGenEucaGolditeTree2 extends WorldGenerator {

	@Override
	public boolean generate(World world, Random rand, BlockPos pos) {
		int i = pos.getX(), j = pos.getY(), k = pos.getZ();
		IBlockState leaves = WorldGenAPI.getEucaGolditeLeaves(rand).getDefaultState(), log = WorldGenAPI.getEucaGolditeLog().getDefaultState();
