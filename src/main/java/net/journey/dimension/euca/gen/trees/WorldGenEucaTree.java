...
public class WorldGenEucaTree extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 4, j, k - 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 4, j, k - 3), leaves);
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 4, j, k + 3), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 4, j, k + 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 4, j + 1, k), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j, k - 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j, k - 3), leaves);
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j, k + 3), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j, k + 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j + 1, k - 1), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j + 1, k), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 3, j + 1, k + 1), leaves);
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 1, j, k + 3), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 1, j, k + 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i - 1, j + 1, k - 3), leaves);
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i, j + 1, k - 4), leaves);
        this.setBlockAndNotifyAdequately(world, new BlockPos(i, j + 1, k - 3), leaves);
