...
public class ChunkProviderNether implements IChunkGenerator {
	...
	public ChunkProviderNether(World worldIn, boolean p_i45637_2_, long seed) {
		...
		this.genNetherBridge = (MapGenNetherBridge) net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(
				genNetherBridge, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.NETHER_BRIDGE);
	...
	public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer) {
		...
		this.heatsoilNoise = this.heatsoilNoiseGen.generateNoiseOctaves(this.heatsoilNoise, p_185937_1_ * 30,
				p_185937_2_ * 16, 0, 16, 16, 1, 0.03125D, 0.03125D, 1.0D);
		this.heatsandNoise = this.heatsandNoiseGen.generateNoiseOctaves(this.heatsandNoise, p_185937_1_ * 10,
				p_185937_2_ * 16, 0, 16, 16, 1, 0.03125D, 0.03125D, 1.0D);
	...
	public void populate(int x, int z) {
		...
		if (net.minecraftforge.event.terraingen.TerrainGen.decorate(this.world, this.rand, chunkpos,
		...
		if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, this.world, this.rand, x, z, false,
			...
			for (int j2 = 0; j2 < 16; ++j2) {
				...
				this.lavaTrapGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + offset,
						this.rand.nextInt(108) + 10, this.rand.nextInt(16) + offset));
			}
	...
	public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position,
		...
		return "Fortress".equals(structureName) && this.genNetherBridge != null
				? this.genNetherBridge.getNearestStructurePos(worldIn, position, findUnexplored) : null;
	}

	@Override
	public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos) {
		return "Fortress".equals(structureName) && this.genNetherBridge != null
				? this.genNetherBridge.isInsideStructure(pos) : false;
	}
