...
public class WorldGenHellThornTall extends WorldGenerator {
    ...
    public boolean generate(World world, Random r, BlockPos pos) {
        ...
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 6, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 7, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 8, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 9, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 10, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
        this.setBlockAndNotifyAdequately(world, new BlockPos(i + 0, j + 11, k + 0), JourneyBlocks.hellThornTop.getDefaultState());
        return true;
    }
}
