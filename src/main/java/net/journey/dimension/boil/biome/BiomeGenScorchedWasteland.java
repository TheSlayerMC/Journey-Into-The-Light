...
public class BiomeGenScorchedWasteland extends JDimensionBiome {

	public BiomeGenScorchedWasteland() {
		super(new BiomeProperties("Scorched Wasteland").setBaseHeight(-5.0F).setHeightVariation(0.1F));
		this.topBlock = JourneyBlocks.scorchedRubble.getDefaultState();
