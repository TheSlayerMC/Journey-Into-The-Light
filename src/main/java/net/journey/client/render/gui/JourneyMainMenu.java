...
public class JourneyMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiJourneyButton(0, this.width / 2 - 206, j + 72 + 12 - 51, I18n.format("menu.options"), false));
        this.buttonList.add(new GuiJourneyButton(4, this.width / 2 + 5, j + 72 + 12 - 51, I18n.format("menu.quit"), true));
        this.buttonList.add(new GuiJourneyLanguageButton(5, this.width / 2 - 206, j + 72 + 12 - 25));
    ...
    private void addSingleplayerMultiplayerButtons(int i, int j) {
        this.buttonList.add(new GuiJourneyButton(1, this.width / 2 - 206, i - 15, I18n.format("menu.singleplayer"), false));
        this.buttonList.add(new GuiJourneyButton(2, this.width / 2 + 5, i + j * 1 - 39, I18n.format("menu.multiplayer"), true));

        this.realmsButton = this.addButton(new GuiJourneyButton(14, this.width / 2 + 5, i + j * 1 - 15, I18n.format("menu.online"), true));

        this.buttonList.add(modButton = new GuiJourneyButton(6, this.width / 2 - 206, i + j * 1 - 15, I18n.format("fml.menu.mods"), false));
    }

    private void addDemoButtons(int p_73972_1_, int p_73972_2_) {
        this.buttonList.add(new GuiJourneyButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo")));
        this.buttonResetDemo = this.addButton(
                new GuiJourneyButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawModalRectWithCustomSizedTexture(j + 90, 67, 0.0F, 0.0F, 93, 12, 93.0F, 12.0F);

        GlStateManager.pushMatrix();
        GlStateManager.translate((float) (this.width / 2 + 90), 40.0F, 0.0F);
