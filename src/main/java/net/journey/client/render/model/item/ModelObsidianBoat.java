package net.journey.client.render.model.item;
...
public class ModelObsidianBoat extends ModelBase implements IMultipassModel {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        EntityObsidianBoat EntityObsidianBoat = (EntityObsidianBoat) entityIn;
        ...
        this.renderPaddle(EntityObsidianBoat, 0, scale, limbSwing);
        this.renderPaddle(EntityObsidianBoat, 1, scale, limbSwing);
    }
    ...
    protected void renderPaddle(EntityObsidianBoat boat, int paddle, float scale, float limbSwing) {
