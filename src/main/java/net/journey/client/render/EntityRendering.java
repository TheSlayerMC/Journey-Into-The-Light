...
public class EntityRendering {
    ...
    public static void init() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityTerranianProtector.class, new RenderBoss(new ModelTerranianProtector(), 0.5F, 2.0F, Textures.terranianProtector, "terranianProtector", EnumHexColorHelper.PURPLE, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntitySoulWatcher.class, new RenderBoss(new ModelSoulWatcher(), 0.5F, 2.0F, Textures.soulWatcher, "soulWatcher", EnumHexColorHelper.RED, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntityNetherBeast.class, new RenderBoss(new ModelBeastOfTheNether(), 0.5F, 2.0F, Textures.netherBeast, "netherBeast", EnumHexColorHelper.RED, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntityWitheringBeast.class, new RenderBoss(new ModelWitheringBeast(), 0.5F, 2.0F, Textures.witheringBeast, "witheringBeast", EnumHexColorHelper.BLACK, EnumHexColorHelper.WHITE));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityTempleGuardian.class, new RenderBoss(new ModelMage(), 0.5F, 2.0F, Textures.templeGuardian, "templeGuardian", EnumHexColorHelper.DARK_GRAY, EnumHexColorHelper.RED));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBlazier.class, new RenderBoss(new ModelBlazier(), 0.5F, 2.0F, Textures.blazier, "blazier", EnumHexColorHelper.WHITE, EnumHexColorHelper.ORANGE));
        RenderingRegistry.registerEntityRenderingHandler(EntitySentryKing.class, new RenderBoss(new ModelSentryKing(), 0.5F, 2.0F, Textures.sentryKing, "sentryKing", EnumHexColorHelper.DARK_GRAY, EnumHexColorHelper.ORANGE));
        RenderingRegistry.registerEntityRenderingHandler(EntityThunderbird.class, new RenderBoss(new ModelRoc(), 0.5F, 2.0F, Textures.thunderbird, "thunderbird", EnumHexColorHelper.DARK_BLUE, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntityLogger.class, new RenderBoss(new ModelLogger(), 0.5F, 2.0F, Textures.logger, "logger", EnumHexColorHelper.GREEN, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntityCorallator.class, new RenderBoss(new ModelCorallator(), 0.5F, 2.0F, Textures.corallator, "corallator", EnumHexColorHelper.ORANGE, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntitySkyStalker.class, new RenderBoss(new ModelSkyStalker(), 0.5F, 2.0F, Textures.skyStalker, "skyStalker", EnumHexColorHelper.PINK, EnumHexColorHelper.WHITE));
        RenderingRegistry.registerEntityRenderingHandler(EntityEudor.class, new RenderBoss(new ModelEudor(), 0.5F, 2.0F, Textures.eudor, "eudor", EnumHexColorHelper.ORANGE, EnumHexColorHelper.YELLOW));
        RenderingRegistry.registerEntityRenderingHandler(EntityScale.class, new RenderBoss(new ModelSoulWatcher(), 0.5F, 2.0F, Textures.scale, "scale", EnumHexColorHelper.LIGHT_BLUE, EnumHexColorHelper.TURQUOISE));
