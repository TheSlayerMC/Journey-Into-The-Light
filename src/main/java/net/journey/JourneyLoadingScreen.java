            ...
            try {
                if (!net.minecraftforge.fml.client.FMLClientHandler.instance().handleLoadingScreen(scaledresolution)) {
                    ...
                    if (progress >= 0) {
                        ...
                        worldrenderer.pos(k1 + i1, l1 + j1, 0.0D).color(128, 128, 128, 255)
                                .endVertex();
                        ...
                        worldrenderer.pos(k1 + progress, l1 + j1, 0.0D).color(128, 255, 128, 255)
                                .endVertex();
                        worldrenderer.pos(k1 + progress, l1, 0.0D).color(128, 255, 128, 255)
                                .endVertex();
                        tessellator.draw();
