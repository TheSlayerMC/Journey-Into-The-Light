...
public class ChatUtils {
	...
	public static void sendInformativeError(EntityPlayer player, String msg, Pair<String, Object>... extraInfo) {
		sendInformativeError(player, msg, new Exception(""));
	}
	 ...
	 */
	@SafeVarargs
	public static void sendInformativeError(EntityPlayer player, String msg, Exception exception, Pair<String, Object>... extraInfo) {
