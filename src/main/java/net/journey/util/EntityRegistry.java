...
public class EntityRegistry {
    ...
    public static EntityEntry[] initProjectiles() {
        ...
        EntityEntry[] JourneyProjectiles = {
                ...
                SlayerAPI.registerProjectile(EntityMagicPot.class, "magicpot"),
                ...
                SlayerAPI.registerProjectile(EntityHellstone.class, "hellstone"),
        };
    ...
    public static EntityEntry[] initMobs() {
        return new EntityEntry[]{
                ...
                SlayerAPI.buildEntityEntry(EntitySentryHeart.class, "sentryheart", "Sentry Heart", 0x000000, 0x9B0000),
                SlayerAPI.buildEntityEntry(EntityGuardianOfDestruction.class, "guardianofdestruction", "Guardian of Destruction", 0x000000, 0x9B0000),
                //Terrania
                ...
                SlayerAPI.buildEntityEntry(EntityAranaKing.class, "aranaking", "Arana King", 0x7813ff, 0xff58f5),
                //Senterian
