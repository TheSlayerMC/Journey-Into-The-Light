...
public class EntityMoltenKnife extends EntityTippedArrow implements IProjectile {
    ...
    public EntityMoltenKnife(World worldIn, EntityLivingBase shooter) {
        super(worldIn, shooter);
    }

    public EntityMoltenKnife(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }

    //apparently used for Fourfa's attack
    public EntityMoltenKnife(World worldIn, EntityLivingBase e, EntityLivingBase eb, float f, float f1) {
        super(worldIn);
    ...
    protected ItemStack getArrowStack() {
        return new ItemStack(JourneyWeapons.moltenKnife);
    }
}