...
public class EntityBloodKnife extends EntityTippedArrow implements IProjectile {
    ...
    public EntityBloodKnife(World worldIn, EntityLivingBase shooter) {
        super(worldIn, shooter);
    }

    public EntityBloodKnife(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }

    //apparently used for Fourfa's attack
    public EntityBloodKnife(World worldIn, EntityLivingBase e, EntityLivingBase eb, float f, float f1) {
        super(worldIn);
