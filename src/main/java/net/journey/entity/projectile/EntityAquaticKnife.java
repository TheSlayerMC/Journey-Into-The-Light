...
public class EntityAquaticKnife extends EntityTippedArrow implements IProjectile {
    ...
    public EntityAquaticKnife(World worldIn, EntityLivingBase shooter) {
        super(worldIn, shooter);
    }

    public EntityAquaticKnife(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
