...
public class EntityEssenceShuriken extends EntityThrowable {

    public float damage;
    public EntityLivingBase thrower;
    protected int bounces, maxBounces;

    public EntityEssenceShuriken(World var1) {
        super(var1);
    }

    public EntityEssenceShuriken(World var1, EntityLivingBase var3, float dam, int max) {
        super(var1, var3);
        this.damage = dam;
        this.thrower = var3;
        this.maxBounces = max;
