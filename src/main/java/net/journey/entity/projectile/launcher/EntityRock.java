...
public class EntityRock extends EntityDamagingProjectile {
    ...
    protected void onImpact(@NotNull RayTraceResult rayTraceResult) {
        if (rayTraceResult.entityHit instanceof EntityLivingBase) {
            ...
            ((EntityLivingBase) rayTraceResult.entityHit).addPotionEffect(new PotionEffect(PotionEffects.getPotionFromID(PotionEffects.moveSlow), 100, 5));
