...
public class EntityWizardsStar extends EntityDamagingProjectile {
    ...
    public void onUpdate() {
        ...
        super.onUpdate();
        for (int i = 0; i < 6; ++i) {
            JITL.proxy.spawnParticle(EnumParticlesClasses.WIZARDS, this.world, this.posX, this.posY - 1.0F, this.posZ, false);
        }
    }
}