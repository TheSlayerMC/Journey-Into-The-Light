...
public class EntityHellwing extends EntityModMob {
    ...
    public EntityHellwing(World par1World) {
        ...
        setSize(0.7F, 1.2F);
        this.boundOrigin = new BlockPos((int) this.posX + this.rand.nextInt(7) - this.rand.nextInt(7),
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true, EntityCreature.class));
    ...
    /*
     * public void setFire(boolean b) { this.dataWatcher.updateObject(16,
     * Byte.valueOf((byte)(b ? 1 : 0))); }
     */
    ...
    class AICopyOwnerTarget extends EntityAITarget {
        ...
        @Override
        public boolean shouldExecute() {
            return EntityHellwing.this.getAttackTarget() != null
                    && this.isSuitableTarget(EntityHellwing.this.getAttackTarget(), false);
        }
