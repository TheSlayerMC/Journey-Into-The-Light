...
public class EntityShiverwolf extends EntityModTameable {
    ...
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.createKey(EntityShiverwolf.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(EntityShiverwolf.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.createKey(EntityShiverwolf.class, DataSerializers.VARINT);
    ...
    public boolean shouldAttackEntity(EntityLivingBase e, EntityLivingBase e2) {
        if (!(e instanceof EntityCreeper) && !(e instanceof EntityGhast)) {
            ...
            return (!(e instanceof EntityPlayer) || !(e2 instanceof EntityPlayer) || ((EntityPlayer) e2).canAttackPlayer((EntityPlayer) e)) && (!(e instanceof EntityHorse) || !((EntityHorse) e).isTame());
        } else {
            return false;
        }
    }
