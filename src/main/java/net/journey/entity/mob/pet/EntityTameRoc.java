...
public class EntityTameRoc extends EntityModTameable {
    ...
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.createKey(EntityTameRoc.class, DataSerializers.FLOAT);
    ...
    public void setTamed(boolean par1) {
        super.setTamed(par1);
        if (par1) this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(MobStats.TameRocHealth);
        else this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(MobStats.RocHealth);
    ...
    public boolean isBreedingItem(ItemStack i) {
        return i != null && i.getItem() == Items.BREAD;
    }
