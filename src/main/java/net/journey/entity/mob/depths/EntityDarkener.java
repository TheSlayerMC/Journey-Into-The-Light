...
public class EntityDarkener extends EntityModFlying {
	...
	private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityDarkener.class, DataSerializers.BOOLEAN);
