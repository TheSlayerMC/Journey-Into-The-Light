...
public class JourneySounds {
    ...
    public static SoundEvent CRYSTAL_ALL_RETRIEVED = registerSound("crystal");
	...
	public static SoundEvent LAVASNAKE_IDLE = registerSound("lavasnake_idle");
	public static SoundEvent LAVASNAKE_HURT = registerSound("lavasnake_hurt");
