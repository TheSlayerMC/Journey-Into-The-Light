...
public class ScrollRegistry {
	...
	public static ScrollEntry testEntry0;
	public static ScrollEntry test;
	...
	public static void register() {
		...
		testEntry0 = ScrollAPI.registerEntry("BASICS", new ScrollEntry("test_entry_" + 0, "Test Entry" + 0, "This is a comment", new ItemStack(Blocks.BARRIER), desc, 10, 10));
		test = ScrollAPI.registerEntry("TEST", new ScrollEntry("testtt", "Test Entry_", "This is a comment", new ItemStack(Blocks.BRICK_BLOCK), desc, 10 + 10, 10 + 10));
		desc.clear();
	}
}
